      ...
      <div className="container mx-auto text-center ">
        ...
        <div className="flex justify-between items-stretch flex-wrap">
          <div className="lg:basis-1/2 lg:px-24 px-10 text-justify">
            ...
            <p className="text-md lg:text-lg tracking-wide py-2 text-slate-500">
            ...
            <HashLink to="/#contact" smooth>
              <button className="rounded-md py-4 px-12 lg:text-left text-center block lg:inline-block mx-auto bg-lime-300  text-md lg:text-lg font-extrabold my-10 tracking-widest drop-shadow-xl">
                CONTACT
              </button>
            </HashLink>
          </div>
          <div className="lg:basis-1/2 pl-4 text-center">
            ...
            <ul className="">
              {skills.map((skill) => (
                <li
                  key={skill.name}
                  className=" bg-gray-200 rounded-lg text-center lg:m-4 m-2 p-3  flex-wrap  inline-flex justify-between items-center text-gray-600 font-bold text-md lg:text-lg"
                >
                  <img
                    src={skill.logo}
                    alt={skill.name}
